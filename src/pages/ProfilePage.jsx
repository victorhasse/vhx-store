      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="flex items-center gap-6 mb-12">
          <div className="w-20 h-20 rounded-sm bg-[#111] border border-white/10 flex items-center justify-center flex-shrink-0">
            <span
              style={{ fontFamily: '"Bebas Neue",sans-serif' }}
              className="text-3xl text-[#C8F135]"
            >
        ...
        <div className="bg-[#111] rounded-sm p-6 mb-6">
          <p
            style={{ fontFamily: '"Bebas Neue",sans-serif' }}
            className="text-xl tracking-widest text-white mb-6"
          >
        ...
        <div className="grid grid-cols-2 gap-3 mb-8">
          ...
          >
            <svg
              ...
              className="w-5 h-5 text-[#C8F135] mb-3"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={1.5}
        ...
        {profile?.role === "admin" && (
          ...
          >
            <p className="text-xs tracking-widest uppercase text-[#C8F135] mb-1">
