    ...
    <div className="flex gap-6 py-6 border-b border-white/5">
      ...
      <div className="flex-1 flex flex-col justify-between">
        <div className="flex justify-between items-start">
          <div>
            <p className="text-[10px] tracking-widest uppercase text-white/30 mb-1">{item.category}</p>
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#111] rounded-sm p-6 sticky top-24">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-white/40 tracking-wider">Frete</span>
                  <span className="text-[#C8F135] text-xs tracking-widest uppercase">Grátis</span>
                </div>
              </div>
